...
module.REQUEST_CLASS_CODE_FIELD.full_name = '.qlua.rpc.Unsubscribe_Level_II_Quotes.Request.class_code'
...
module.REQUEST_SEC_CODE_FIELD.full_name = '.qlua.rpc.Unsubscribe_Level_II_Quotes.Request.sec_code'
...
module.REQUEST.full_name = '.qlua.rpc.Unsubscribe_Level_II_Quotes.Request'
...
module.RESULT_RESULT_FIELD.full_name = '.qlua.rpc.Unsubscribe_Level_II_Quotes.Result.result'
...
module.RESULT.full_name = '.qlua.rpc.Unsubscribe_Level_II_Quotes.Result'
