...
module.REQUEST_T_ID_FIELD.full_name = '.qlua.rpc.Clear.Request.t_id'
...
module.REQUEST.full_name = '.qlua.rpc.Clear.Request'
...
module.RESULT_RESULT_FIELD.full_name = '.qlua.rpc.Clear.Result.result'
...
module.RESULT.full_name = '.qlua.rpc.Clear.Result'
