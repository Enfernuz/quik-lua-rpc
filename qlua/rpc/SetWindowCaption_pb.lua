...
module.REQUEST_STR_FIELD = protobuf.FieldDescriptor()
module.RESULT = protobuf.Descriptor()
module.RESULT_RESULT_FIELD = protobuf.FieldDescriptor()

module.REQUEST_T_ID_FIELD.name = 't_id'
module.REQUEST_T_ID_FIELD.full_name = '.qlua.rpc.SetWindowCaption.Request.t_id'
...
module.REQUEST_STR_FIELD.name = 'str'
module.REQUEST_STR_FIELD.full_name = '.qlua.rpc.SetWindowCaption.Request.str'
module.REQUEST_STR_FIELD.number = 2
module.REQUEST_STR_FIELD.index = 1
module.REQUEST_STR_FIELD.label = 1
module.REQUEST_STR_FIELD.has_default_value = false
module.REQUEST_STR_FIELD.default_value = ''
module.REQUEST_STR_FIELD.type = 9
module.REQUEST_STR_FIELD.cpp_type = 9

module.REQUEST.name = 'Request'
module.REQUEST.full_name = '.qlua.rpc.SetWindowCaption.Request'
module.REQUEST.nested_types = {}
module.REQUEST.enum_types = {}
module.REQUEST.fields = {module.REQUEST_T_ID_FIELD, module.REQUEST_STR_FIELD}
module.REQUEST.is_extendable = false
module.REQUEST.extensions = {}
module.RESULT_RESULT_FIELD.name = 'result'
module.RESULT_RESULT_FIELD.full_name = '.qlua.rpc.SetWindowCaption.Result.result'
...
module.RESULT.full_name = '.qlua.rpc.SetWindowCaption.Result'
