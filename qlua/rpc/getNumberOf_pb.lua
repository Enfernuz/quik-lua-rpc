...
module.REQUEST_TABLE_NAME_FIELD.full_name = '.qlua.rpc.getNumberOf.Request.table_name'
...
module.REQUEST.full_name = '.qlua.rpc.getNumberOf.Request'
module.REQUEST.nested_types = {}
module.REQUEST.enum_types = {}
module.REQUEST.fields = {module.REQUEST_TABLE_NAME_FIELD}
module.REQUEST.is_extendable = false
module.REQUEST.extensions = {}
module.RESULT_RESULT_FIELD.name = 'result'
module.RESULT_RESULT_FIELD.full_name = '.qlua.rpc.getNumberOf.Result.result'
...
module.RESULT.full_name = '.qlua.rpc.getNumberOf.Result'
