...
module.REQUEST_T_ID_FIELD.full_name = '.qlua.rpc.DeleteRow.Request.t_id'
...
module.REQUEST_KEY_FIELD.full_name = '.qlua.rpc.DeleteRow.Request.key'
...
module.REQUEST.full_name = '.qlua.rpc.DeleteRow.Request'
...
module.RESULT_RESULT_FIELD.full_name = '.qlua.rpc.DeleteRow.Result.result'
...
module.RESULT.full_name = '.qlua.rpc.DeleteRow.Result'
