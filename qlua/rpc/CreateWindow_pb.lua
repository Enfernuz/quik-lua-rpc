...
module.REQUEST_T_ID_FIELD.full_name = '.qlua.rpc.CreateWindow.Request.t_id'
...
module.REQUEST.full_name = '.qlua.rpc.CreateWindow.Request'
...
module.RESULT_RESULT_FIELD.full_name = '.qlua.rpc.CreateWindow.Result.result'
...
module.RESULT.full_name = '.qlua.rpc.CreateWindow.Result'
