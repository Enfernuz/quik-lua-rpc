...
module.REQUEST_DATASOURCE_UUID_FIELD.full_name = '.qlua.rpc.datasource.SetEmptyCallback.Request.datasource_uuid'
...
module.REQUEST.full_name = '.qlua.rpc.datasource.SetEmptyCallback.Request'
...
module.RESULT_RESULT_FIELD.full_name = '.qlua.rpc.datasource.SetEmptyCallback.Result.result'
...
module.RESULT.full_name = '.qlua.rpc.datasource.SetEmptyCallback.Result'
