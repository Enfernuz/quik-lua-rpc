...
module.REQUEST_DATASOURCE_UUID_FIELD.full_name = '.qlua.rpc.datasource.H.Request.datasource_uuid'
...
module.REQUEST_CANDLE_INDEX_FIELD.full_name = '.qlua.rpc.datasource.H.Request.candle_index'
...
module.REQUEST.full_name = '.qlua.rpc.datasource.H.Request'
...
module.RESULT_VALUE_FIELD.full_name = '.qlua.rpc.datasource.H.Result.value'
module.RESULT_VALUE_FIELD.number = 1
module.RESULT_VALUE_FIELD.index = 0
...
module.RESULT.full_name = '.qlua.rpc.datasource.H.Result'
module.RESULT.nested_types = {}
module.RESULT.enum_types = {}
module.RESULT.fields = {module.RESULT_VALUE_FIELD}
