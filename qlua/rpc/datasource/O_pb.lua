...
module.REQUEST_DATASOURCE_UUID_FIELD.full_name = '.qlua.rpc.datasource.O.Request.datasource_uuid'
...
module.REQUEST_CANDLE_INDEX_FIELD.full_name = '.qlua.rpc.datasource.O.Request.candle_index'
...
module.REQUEST.full_name = '.qlua.rpc.datasource.O.Request'
...
module.RESULT_VALUE_FIELD.full_name = '.qlua.rpc.datasource.O.Result.value'
...
module.RESULT.full_name = '.qlua.rpc.datasource.O.Result'
