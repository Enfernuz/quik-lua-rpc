...
local function assertQLuaFunctionExists (func_name)
  assert(_G[func_name], string.format("Функция '%s' не найдена.", func_name))
end

-- Global QLua functions
assertQLuaFunctionExists("isConnected")
assertQLuaFunctionExists("getScriptPath")
assertQLuaFunctionExists("getInfoParam")
assertQLuaFunctionExists("getItem")
assertQLuaFunctionExists("message")
assertQLuaFunctionExists("sleep")
assertQLuaFunctionExists("getWorkingFolder")
assertQLuaFunctionExists("PrintDbgStr")
assertQLuaFunctionExists("getOrderByNumber")
assertQLuaFunctionExists("getNumberOf")
assertQLuaFunctionExists("SearchItems")
assertQLuaFunctionExists("getClassesList")
assertQLuaFunctionExists("getClassInfo")
assertQLuaFunctionExists("getClassSecurities")
assertQLuaFunctionExists("getMoney")
assertQLuaFunctionExists("getMoneyEx")
assertQLuaFunctionExists("getDepo")
assertQLuaFunctionExists("getDepoEx")
assertQLuaFunctionExists("getFuturesLimit")
assertQLuaFunctionExists("getFuturesHolding")
assertQLuaFunctionExists("getSecurityInfo")
assertQLuaFunctionExists("getTradeDate")
assertQLuaFunctionExists("getQuoteLevel2")
assertQLuaFunctionExists("getLinesCount")
assertQLuaFunctionExists("getNumCandles")
assertQLuaFunctionExists("getCandlesByIndex")
assertQLuaFunctionExists("CreateDataSource")
assertQLuaFunctionExists("sendTransaction")
assertQLuaFunctionExists("CalcBuySell")
assertQLuaFunctionExists("getParamEx")
assertQLuaFunctionExists("getParamEx2")
assertQLuaFunctionExists("getPortfolioInfo")
assertQLuaFunctionExists("getPortfolioInfoEx")
assertQLuaFunctionExists("getBuySellInfo")
assertQLuaFunctionExists("getBuySellInfoEx")
assertQLuaFunctionExists("AddColumn")
assertQLuaFunctionExists("AllocTable")
assertQLuaFunctionExists("Clear")
assertQLuaFunctionExists("CreateWindow")
assertQLuaFunctionExists("DeleteRow")
assertQLuaFunctionExists("DestroyTable")
assertQLuaFunctionExists("InsertRow")
assertQLuaFunctionExists("IsWindowClosed")
assertQLuaFunctionExists("GetCell")
assertQLuaFunctionExists("GetTableSize")
assertQLuaFunctionExists("GetWindowCaption")
assertQLuaFunctionExists("GetWindowRect")
assertQLuaFunctionExists("SetCell")
assertQLuaFunctionExists("SetWindowCaption")
assertQLuaFunctionExists("SetWindowPos")
assertQLuaFunctionExists("SetTableNotificationCallback")
assertQLuaFunctionExists("RGB")
assertQLuaFunctionExists("SetColor")
assertQLuaFunctionExists("Highlight")
assertQLuaFunctionExists("SetSelectedRow")
assertQLuaFunctionExists("AddLabel")
assertQLuaFunctionExists("DelLabel")
assertQLuaFunctionExists("DelAllLabels")
assertQLuaFunctionExists("GetLabelParams")
assertQLuaFunctionExists("SetLabelParams")
assertQLuaFunctionExists("Subscribe_Level_II_Quotes")
assertQLuaFunctionExists("Unsubscribe_Level_II_Quotes")
assertQLuaFunctionExists("IsSubscribed_Level_II_Quotes")
assertQLuaFunctionExists("ParamRequest")
assertQLuaFunctionExists("CancelParamRequest")
