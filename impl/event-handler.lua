local qlua_event_data = require("quik-lua-rpc.messages.qlua_event_data_pb")
...
local function value_or_empty_string(val)
  return (val == nil and "" or val)
end

local function value_to_string_or_empty_string(val)
  return (val == nil and "" or tostring(val))
end

event_handlers[qlua_event_data.EventType.PUBLISHER_ONLINE] = return_nil
event_handlers[qlua_event_data.EventType.PUBLISHER_OFFLINE] = return_nil
event_handlers[qlua_event_data.EventType.ON_CLOSE] = return_nil
event_handlers[qlua_event_data.EventType.ON_CONNECTED] = return_nil
event_handlers[qlua_event_data.EventType.ON_DISCONNECTED] = return_nil
event_handlers[qlua_event_data.EventType.ON_CLEAN_UP] = return_nil

event_handlers[qlua_event_data.EventType.ON_FIRM] = function(firm) 
  local result = qlua_event_data.Firm()
...
event_handlers[qlua_event_data.EventType.ON_ALL_TRADE] = function(alltrade) 
  local result = qlua_event_data.AllTrade()
...
event_handlers[qlua_event_data.EventType.ON_TRADE] = function(trade) 
  local result = qlua_event_data.Trade()
...
event_handlers[qlua_event_data.EventType.ON_ORDER] = function(order) 
  local result = qlua_event_data.Order()
...
event_handlers[qlua_event_data.EventType.ON_ACCOUNT_BALANCE] = function(acc_bal) 
  local result = qlua_event_data.AccountBalance()
...
event_handlers[qlua_event_data.EventType.ON_FUTURES_LIMIT_CHANGE] = function(fut_limit) 
  local result = qlua_event_data.FuturesLimit()
...
event_handlers[qlua_event_data.EventType.ON_FUTURES_LIMIT_DELETE] = function(lim_del) 
  local result = qlua_event_data.FuturesLimitDelete()
...
event_handlers[qlua_event_data.EventType.ON_FUTURES_CLIENT_HOLDING] = function(fut_pos) 
  local result = qlua_event_data.FuturesClientHolding()
...
event_handlers[qlua_event_data.EventType.ON_MONEY_LIMIT] = function(mlimit) 
  local result = qlua_event_data.MoneyLimit()
...
event_handlers[qlua_event_data.EventType.ON_MONEY_LIMIT_DELETE] = function(mlimit_del) 
  local result = qlua_event_data.MoneyLimitDelete()
...
event_handlers[qlua_event_data.EventType.ON_DEPO_LIMIT] = function(dlimit) 
  local result = qlua_event_data.DepoLimit()
...
event_handlers[qlua_event_data.EventType.ON_DEPO_LIMIT_DELETE] = function(dlimit_del) 
  local result = qlua_event_data.DepoLimitDelete()
...
event_handlers[qlua_event_data.EventType.ON_ACCOUNT_POSITION] = function(acc_pos) 
  local result = qlua_event_data.AccountPosition()
...
event_handlers[qlua_event_data.EventType.ON_NEG_DEAL] = function(neg_deal) 
  local result = qlua_event_data.NegDeal()
...
event_handlers[qlua_event_data.EventType.ON_NEG_TRADE] = function(neg_trade) 
  local result = qlua_event_data.NegTrade()
...
event_handlers[qlua_event_data.EventType.ON_STOP_ORDER] = function(stop_order) 
  local result = qlua_event_data.StopOrder()
...
event_handlers[qlua_event_data.EventType.ON_TRANS_REPLY] = function(trans_reply) 
  local result = qlua_event_data.TransReply()
...
event_handlers[qlua_event_data.EventType.ON_PARAM] = function(param) 
  local result = qlua_event_data.ParamEventData()
  
  result.class_code = param.class_code
  result.sec_code = param.sec_code
  
  return result
end

event_handlers[qlua_event_data.EventType.ON_QUOTE] = function(quote) 
  local result = qlua_event_data.QuoteEventData()
  
  result.class_code = quote.class_code
  result.sec_code = quote.sec_code
