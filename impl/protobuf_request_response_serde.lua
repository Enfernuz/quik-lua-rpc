...
local api = require("qlua.new_api")
local pb = require("pb")

function module.deserialize_request (serialized_request)
  
  local request = pb.decode(".qlua.rpc.RPC.Request", serialized_request)
...
function module.serialize_response (deserialized_response)
  ...
  local response = pb.defaults(".qlua.rpc.RPC.Response")
  ...
  return pb.encode(".qlua.rpc.RPC.Response", response)
end
