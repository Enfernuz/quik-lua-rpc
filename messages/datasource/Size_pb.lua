...
module.REQUEST_DATASOURCE_UUID_FIELD.full_name = '.qlua.rpc.datasource.Size.Request.datasource_uuid'
...
module.REQUEST.full_name = '.qlua.rpc.datasource.Size.Request'
module.REQUEST.nested_types = {}
module.REQUEST.enum_types = {}
module.REQUEST.fields = {module.REQUEST_DATASOURCE_UUID_FIELD}
module.REQUEST.is_extendable = false
module.REQUEST.extensions = {}
module.RESULT_VALUE_FIELD.name = 'value'
module.RESULT_VALUE_FIELD.full_name = '.qlua.rpc.datasource.Size.Result.value'
...
module.RESULT_VALUE_FIELD.default_value = 0
module.RESULT_VALUE_FIELD.type = 5
module.RESULT_VALUE_FIELD.cpp_type = 1

module.RESULT.name = 'Result'
module.RESULT.full_name = '.qlua.rpc.datasource.Size.Result'
