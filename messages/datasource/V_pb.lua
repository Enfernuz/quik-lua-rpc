...
module.REQUEST_DATASOURCE_UUID_FIELD.full_name = '.qlua.rpc.datasource.V.Request.datasource_uuid'
...
module.REQUEST_CANDLE_INDEX_FIELD.full_name = '.qlua.rpc.datasource.V.Request.candle_index'
...
module.REQUEST.full_name = '.qlua.rpc.datasource.V.Request'
...
module.RESULT_VALUE_FIELD.full_name = '.qlua.rpc.datasource.V.Result.value'
...
module.RESULT.full_name = '.qlua.rpc.datasource.V.Result'
