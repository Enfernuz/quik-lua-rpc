...
module.REQUEST_T_ID_FIELD.full_name = '.qlua.rpc.IsWindowClosed.Request.t_id'
...
module.REQUEST.full_name = '.qlua.rpc.IsWindowClosed.Request'
...
module.RESULT_RESULT_FIELD.full_name = '.qlua.rpc.IsWindowClosed.Result.result'
...
module.RESULT.full_name = '.qlua.rpc.IsWindowClosed.Result'
