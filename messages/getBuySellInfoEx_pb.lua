...
local imports = {}
imports['quik-lua-rpc/messages/getBuySellInfo_pb'] = require 'quik-lua-rpc/messages/getBuySellInfo_pb'
...
module.BUYSELLINFOEX_BUY_SELL_INFO_FIELD.message_type = imports['quik-lua-rpc/messages/getBuySellInfo_pb'].BUYSELLINFO
