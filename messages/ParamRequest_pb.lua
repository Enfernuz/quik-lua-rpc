...
module.REQUEST_CLASS_CODE_FIELD.full_name = '.qlua.rpc.ParamRequest.Request.class_code'
...
module.REQUEST_SEC_CODE_FIELD.full_name = '.qlua.rpc.ParamRequest.Request.sec_code'
...
module.REQUEST_DB_NAME_FIELD.full_name = '.qlua.rpc.ParamRequest.Request.db_name'
...
module.REQUEST.full_name = '.qlua.rpc.ParamRequest.Request'
...
module.RESULT_RESULT_FIELD.full_name = '.qlua.rpc.ParamRequest.Result.result'
...
module.RESULT.full_name = '.qlua.rpc.ParamRequest.Result'
