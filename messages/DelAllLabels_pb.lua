...
module.REQUEST_CHART_TAG_FIELD.full_name = '.qlua.rpc.DelAllLabels.Request.chart_tag'
...
module.REQUEST.full_name = '.qlua.rpc.DelAllLabels.Request'
module.REQUEST.nested_types = {}
module.REQUEST.enum_types = {}
module.REQUEST.fields = {module.REQUEST_CHART_TAG_FIELD}
module.REQUEST.is_extendable = false
module.REQUEST.extensions = {}
module.RESULT_RESULT_FIELD.name = 'result'
module.RESULT_RESULT_FIELD.full_name = '.qlua.rpc.DelAllLabels.Result.result'
...
module.RESULT.full_name = '.qlua.rpc.DelAllLabels.Result'
