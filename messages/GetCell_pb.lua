...
module.RESULT_IMAGE_FIELD = protobuf.FieldDescriptor()
module.RESULT_VALUE_FIELD = protobuf.FieldDescriptor()

module.REQUEST_T_ID_FIELD.name = 't_id'
module.REQUEST_T_ID_FIELD.full_name = '.qlua.rpc.GetCell.Request.t_id'
...
module.REQUEST_KEY_FIELD.full_name = '.qlua.rpc.GetCell.Request.key'
...
module.REQUEST_CODE_FIELD.full_name = '.qlua.rpc.GetCell.Request.code'
...
module.REQUEST.full_name = '.qlua.rpc.GetCell.Request'
module.REQUEST.nested_types = {}
module.REQUEST.enum_types = {}
module.REQUEST.fields = {module.REQUEST_T_ID_FIELD, module.REQUEST_KEY_FIELD, module.REQUEST_CODE_FIELD}
module.REQUEST.is_extendable = false
module.REQUEST.extensions = {}
module.RESULT_IMAGE_FIELD.name = 'image'
module.RESULT_IMAGE_FIELD.full_name = '.qlua.rpc.GetCell.Result.image'
module.RESULT_IMAGE_FIELD.number = 1
module.RESULT_IMAGE_FIELD.index = 0
module.RESULT_IMAGE_FIELD.label = 1
module.RESULT_IMAGE_FIELD.has_default_value = false
module.RESULT_IMAGE_FIELD.default_value = ''
module.RESULT_IMAGE_FIELD.type = 9
module.RESULT_IMAGE_FIELD.cpp_type = 9

module.RESULT_VALUE_FIELD.name = 'value'
module.RESULT_VALUE_FIELD.full_name = '.qlua.rpc.GetCell.Result.value'
module.RESULT_VALUE_FIELD.number = 2
module.RESULT_VALUE_FIELD.index = 1
module.RESULT_VALUE_FIELD.label = 1
module.RESULT_VALUE_FIELD.has_default_value = false
module.RESULT_VALUE_FIELD.default_value = ''
module.RESULT_VALUE_FIELD.type = 9
module.RESULT_VALUE_FIELD.cpp_type = 9

module.RESULT.name = 'Result'
module.RESULT.full_name = '.qlua.rpc.GetCell.Result'
module.RESULT.nested_types = {}
module.RESULT.enum_types = {}
module.RESULT.fields = {module.RESULT_IMAGE_FIELD, module.RESULT_VALUE_FIELD}
