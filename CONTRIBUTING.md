...
Для тех, кто не силён в работе с Git, можно скачать исходные коды напрямую: https://github.com/zeromq/libzmq/releases/download/v4.2.3/zeromq-4.2.3.zip или https://github.com/zeromq/libzmq/archive/v4.2.3.zip

Здесь может возникнуть вопрос: зачем нам самим собирать `libzmq`, а не взять уже готовую DLL, скажем, отсюда: http://zeromq.org/distro:microsoft-windows ?
...
Для тех, кто не силён в работе с Git, можно скачать исходные коды напрямую: https://github.com/jedisct1/libsodium/releases/download/1.0.16/libsodium-1.0.16.tar.gz или https://github.com/jedisct1/libsodium/archive/1.0.16.zip
