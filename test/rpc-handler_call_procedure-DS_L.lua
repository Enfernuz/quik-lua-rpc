...
describe("impl.rpc-handler", function()
  ...
  describe("WHEN given a request of type ProcedureType.DS_L", function()
    ...
    setup(function()
      ...
      request = {}
      request.type = qlua.RPC.ProcedureType.DS_L
    end)
    ...
    insulate("WITH arguments", function()
      ...
      setup(function()
        ...
        request_args = qlua.datasource.L.Request()
        ...
        datasource = {
          L = spy.new(function(candle_index) return proc_result end)
        }
      ...
      it("SHOULD call the 'L' function on the datasource returned by its 'get_datasource' function, passing self and the 'candle_index' argument it", function()
        ...
        assert.spy(datasource.L).was.called_with(datasource, request_args.candle_index)
      end)
    
      it("SHOULD return a qlua.datasource.L.Result instance", function()
          
        local actual_result = sut.call_procedure(request.type, request)
        local expected_result = qlua.datasource.L.Result()
