...
describe("impl.rpc-handler", function()
  ...
  describe("WHEN given a request of type ProcedureType.DS_SIZE", function()
    ...
    setup(function()
      ...
      request = {}
      request.type = qlua.RPC.ProcedureType.DS_SIZE
    end)
    ...
    insulate("WITH arguments", function()
      ...
      setup(function()
        ...
        request_args = qlua.datasource.Size.Request()
        ...
        datasource = {
          Size = spy.new(function(candle_index) return proc_result end)
        }
