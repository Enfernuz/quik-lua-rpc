...
describe("impl.rpc-handler", function()
  ...
  describe("WHEN given a request of type ProcedureType.GET_NUMBER_OF", function()
    ...
    setup(function()
      ...
      request = {}
      request.type = qlua.RPC.ProcedureType.GET_NUMBER_OF
    end)
    ...
    insulate("WITH arguments", function()
      ...
      setup(function()
        ...
        request_args = qlua.getNumberOf.Request()
        ...
        _G.getNumberOf = spy.new(function(time) return proc_result end)
      end)
      ...
      it("SHOULD call the global 'getNumberOf' function once, passing the procedure arguments to it", function()
      ...
      it("SHOULD return a qlua.getNumberOf.Result instance", function()
          
        local actual_result = sut.call_procedure(request.type, request)
        local expected_result = qlua.getNumberOf.Result()
