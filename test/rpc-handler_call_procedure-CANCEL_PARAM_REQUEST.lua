...
describe("impl.rpc-handler", function()
  ...
  describe("WHEN given a request of type ProcedureType.CANCEL_PARAM_REQUEST", function()
    ...
    setup(function()
      ...
      request = {}
      request.type = qlua.RPC.ProcedureType.CANCEL_PARAM_REQUEST
    end)
    ...
    insulate("WITH arguments", function()
      ...
      setup(function()
        ...
        request_args = qlua.CancelParamRequest.Request()
        ...
        _G.CancelParamRequest = spy.new(function(class_code, sec_code, db_name) return proc_result end)
      end)
      ...
      it("SHOULD call the global 'CancelParamRequest' function once, passing the procedure arguments to it", function()
        
        local response = sut.call_procedure(request.type, request.args)
    
        assert.spy(_G.CancelParamRequest).was.called_with(request_args.class_code, request_args.sec_code, request_args.db_name)
      end)
