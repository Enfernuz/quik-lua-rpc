    ...
    describe("WITH arguments", function()
      ...
      describe("WHERE the argument 'interval'", function()
        ...
        describe("IS NOT Interval.UNDEFINED", function()
          ...
          -- WARNING: a shady test. Need something more specific.
          it("SHOULD return the result of the global CreateDataSource function given the uuid generated by the global 'uuid' function's recent call", function()
