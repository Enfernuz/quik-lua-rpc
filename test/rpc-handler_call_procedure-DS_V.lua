...
describe("impl.rpc-handler", function()
  ...
  describe("WHEN given a request of type ProcedureType.DS_V", function()
    ...
    setup(function()
      ...
      request = {}
      request.type = qlua.RPC.ProcedureType.DS_V
    end)
    ...
    insulate("WITH arguments", function()
      ...
      setup(function()
        ...
        request_args = qlua.datasource.V.Request()
        ...
        datasource = {
          V = spy.new(function(candle_index) return proc_result end)
        }
      ...
      it("SHOULD call the 'V' function on the datasource returned by its 'get_datasource' function, passing self and the 'candle_index' argument to it", function()
          
        sut.call_procedure(request.type, request.args)
        
        assert.spy(datasource.V).was.called_with(datasource, request_args.candle_index)
      end)
    
      it("SHOULD return a qlua.datasource.V.Result instance", function()
          
        local actual_result = sut.call_procedure(request.type, request.args)
        local expected_result = qlua.datasource.V.Result()
