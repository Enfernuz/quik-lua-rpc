...
describe("impl.rpc-handler", function()
  ...
  describe("WHEN given a request of type ProcedureType.BIT_BOR", function()
    ...
    setup(function()
      ...
      request = {}
      request.type = qlua.RPC.ProcedureType.BIT_BOR
    end)
    ...
    describe("WITH arguments", function()
      ...
      setup(function()
        ...
        request_args = qlua.bit.bor.Request()
        request_args.x1 = 1
        request_args.x2 = 8
      ...
      it("SHOULD call the global 'bit.bor' function once, passing the unpacked array {x1, x2, xi[1], xi[2], ..., xi[#xi]} to it", function()
        local response = sut.call_procedure(request.type, request.args)
        
        assert.spy(bit.bor).was.called_with( unpack(arr) )
        
        bit.bor:revert()
      end)
    
      it("SHOULD return a qlua.bit.bor.Result instance", function()
          
        local actual_result = sut.call_procedure(request.type, request.args)
        local expected_result = qlua.bit.bor.Result()
      ...
      it("SHOULD return a protobuf object which string-serialized form equals to that of the expected result", function()
        ...
        expected_result.result = bit.bor( unpack(arr) )
