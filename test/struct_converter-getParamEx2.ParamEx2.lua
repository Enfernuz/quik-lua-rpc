...
describe("The function utils.struct_converter.getParamEx2.ParamEx2", function()
  ...
  describe("WHEN given no 'param_ex' table", function()
    ...
    it("SHOULD raise an error", function()
      assert.has_error(sut.getParamEx2.ParamEx2, "No 'param_ex' table provided.")
    end)
  end)
  ...
  describe("WHEN given a 'param_ex' table", function()
    ...
    it("SHOULD return an equal protobuf getParamEx2.ParamEx2 struct", function()
        
      local result = sut.getParamEx2.ParamEx2(param_ex)
        
      -- check the result is a protobuf getParamEx2.ParamEx2 structure
      local expected_meta = getmetatable( qlua.getParamEx2.ParamEx2() )
    ...
    describe("AND an existing getParamEx2.ParamEx2 protobuf struct", function()
      
      local existing_struct
      
      setup(function()
        existing_struct = qlua.getParamEx2.ParamEx2()
      end)
      ...
      it("SHOULD return the existing getParamEx2.ParamEx2 protobuf struct which equals (data-wide, not literally) to the given 'param_ex' table", function()
          
        local result = sut.getParamEx2.ParamEx2(param_ex, existing_struct)
    ...
    for _, field_name in ipairs(nonnullable_fields_names) do
      ...
      describe(string.format("with no field '%s'", field_name), function()
        ...
        it("SHOULD raise an error", function()
          assert.has_error(function() sut.getParamEx2.ParamEx2(param_ex) end)
        end)
      end)
  ...
  describe("WHEN given a 'param_ex' with CP1251-encoded values", function()
    ...
    it("SHOULD return a struct with UTF8 encoded values", function()
      ...
      local result = sut.getParamEx2.ParamEx2(param_ex_cp1251)
