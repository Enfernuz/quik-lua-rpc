...
local value_to_string_or_empty_string = nil --assert(utils.value_to_string_or_empty_string) --TODO: remove this variable
...
function StructFactory.create_Firm(firm, existing_struct)
  ...
  result.firmid = utils.Cp1251ToUtf8(firm.firmid)
...
function StructFactory.create_Order(order, existing_struct)
  ...
  if order == nil then error("Не задан аргумент-таблица 'order'.", 2) end
  
  local result = (existing_struct == nil and qlua_structs.Order() or existing_struct)

  -- A looping through the order's fields strategy doesn't work 
  -- because the QLua devs might add some new fields which wouldn't be presented in the protobuf object
  ...
  result.balance = value_or_empty_string(order.balance)
  result.value = order.value
  result.accruedint = value_or_empty_string(order.accruedint)
  result.yield = value_or_empty_string(order.yield)
  result.trans_id = value_or_empty_string(order.trans_id)
  result.client_code = value_or_empty_string(order.client_code)
  result.price2 = value_or_empty_string(order.price2)
  result.settlecode = value_or_empty_string(order.settlecode)
  result.uid = value_or_empty_string(order.uid)
  result.canceled_uid = value_or_empty_string(order.canceled_uid)
  result.exchange_code = value_or_empty_string(order.exchange_code)
  result.activation_time = value_or_empty_string(order.activation_time)
  result.linkedorder = value_or_empty_string(order.linkedorder)
  result.expiry = value_or_empty_string(order.expiry)
  ...
  result.repoterm = value_or_empty_string(order.repoterm)
  result.repovalue = value_or_empty_string(order.repovalue)
  result.repo2value = value_or_empty_string(order.repo2value)
  result.repo_value_balance = value_or_empty_string(order.repo_value_balance)
  result.start_discount = value_or_empty_string(order.start_discount)
  result.reject_reason = value_or_empty_string(order.reject_reason)
  result.ext_order_flags = value_or_empty_string(order.ext_order_flags)
...
function StructFactory.create_AccountBalance(acc_bal, existing_struct)
  ...
  result.firmid = utils.Cp1251ToUtf8( assert(acc_bal.firmid, "The given 'acc_bal' table has no 'firmid' field.") )
  result.sec_code = assert(acc_bal.sec_code, "The given 'acc_bal' table has no 'sec_code' field.")
  result.trdaccid = utils.Cp1251ToUtf8( assert(acc_bal.trdaccid, "The given 'acc_bal' table has no 'trdaccid' field.") )
  result.depaccid = utils.Cp1251ToUtf8( assert(acc_bal.depaccid, "The given 'acc_bal' table has no 'depaccid' field.") )
...
function StructFactory.create_FuturesLimit(fut_limit, existing_struct)
  ...
  result.firmid = utils.Cp1251ToUtf8( assert(fut_limit.firmid, "The given 'fut_limit' table has no 'firmid' field.") )
  result.trdaccid = utils.Cp1251ToUtf8( assert(fut_limit.trdaccid, "The given 'fut_limit' table has no 'trdaccid' field.") )
  ...
  result.currcode = utils.Cp1251ToUtf8( assert(fut_limit.currcode, "The given 'fut_limit' table has no 'currcode' field.") )
...
function StructFactory.create_FuturesLimitDelete(lim_del, existing_struct)
  ...
  result.firmid = utils.Cp1251ToUtf8( assert(lim_del.firmid, "The given 'lim_del' table has no 'firmid' field.") )
...
function StructFactory.create_FuturesClientHolding(fut_pos, existing_struct)
  ...
  result.firmid = utils.Cp1251ToUtf8( assert(fut_pos.firmid, "The given 'fut_pos' table has no 'firmid' field.") )
  result.trdaccid = utils.Cp1251ToUtf8( assert(fut_pos.trdaccid, "The given 'fut_pos' table has no 'trdaccid' field.") )
...
function StructFactory.create_MoneyLimit(mlimit, existing_struct)
  ...
  result.currcode = utils.Cp1251ToUtf8( assert(mlimit.currcode, "The given 'mlimit' table has no 'currcode' field.") )
  result.tag = utils.Cp1251ToUtf8( assert(mlimit.tag, "The given 'mlimit' table has no 'tag' field.") )
  result.firmid = utils.Cp1251ToUtf8( assert(mlimit.firmid, "The given 'mlimit' table has no 'firmid' field.") )
  result.client_code = utils.Cp1251ToUtf8( assert(mlimit.client_code, "The given 'mlimit' table has no 'client_code' field.") )
...
function StructFactory.create_MoneyLimitDelete(mlimit_del, existing_struct)
  ...
  result.currcode = utils.Cp1251ToUtf8( assert(mlimit_del.currcode, "The given 'mlimit_del' table has no 'currcode' field.") )
  result.tag = utils.Cp1251ToUtf8( assert(mlimit_del.tag, "The given 'mlimit_del' table has no 'tag' field.") )
  result.client_code = utils.Cp1251ToUtf8( assert(mlimit_del.client_code, "The given 'mlimit_del' table has no 'client_code' field.") )
  result.firmid = utils.Cp1251ToUtf8( assert(mlimit_del.firmid, "The given 'mlimit_del' table has no 'firmid' field.") )
...
function StructFactory.create_DepoLimit(dlimit, existing_struct)
  ...
  result.sec_code = utils.Cp1251ToUtf8( assert(dlimit.sec_code, "The given 'dlimit' table has no 'sec_code' field.") )
  result.trdaccid = utils.Cp1251ToUtf8( assert(dlimit.trdaccid, "The given 'dlimit' table has no 'trdaccid' field.") )
  result.firmid = utils.Cp1251ToUtf8( assert(dlimit.firmid, "The given 'dlimit' table has no 'firmid' field.") )
  result.client_code = utils.Cp1251ToUtf8( assert(dlimit.client_code, "The given 'dlimit' table has no 'client_code' field.") )
...
function StructFactory.create_DepoLimitDelete(dlimit_del, existing_struct)
  ...
  result.sec_code = utils.Cp1251ToUtf8( assert(dlimit_del.sec_code, "The given 'dlimit_del' table has no 'sec_code' field.") )
  result.trdaccid = utils.Cp1251ToUtf8( assert(dlimit_del.trdaccid, "The given 'dlimit_del' table has no 'trdaccid' field.") )
  result.firmid = utils.Cp1251ToUtf8( assert(dlimit_del.firmid, "The given 'dlimit_del' table has no 'firmid' field.") )
  result.client_code = utils.Cp1251ToUtf8( assert(dlimit_del.client_code, "The given 'dlimit_del' table has no 'client_code' field.") )
...
function StructFactory.create_AccountPosition(acc_pos, existing_struct)
  ...
  result.firmid = utils.Cp1251ToUtf8( assert(acc_pos.firmid, "The given 'acc_pos' table has no 'firmid' field.") )
  result.currcode = utils.Cp1251ToUtf8( assert(acc_pos.currcode, "The given 'acc_pos' table has no 'currcode' field.") )
  result.tag = utils.Cp1251ToUtf8( assert(acc_pos.tag, "The given 'acc_pos' table has no 'tag' field.") )
...
function StructFactory.create_NegDeal(neg_deal, existing_struct)
  ...
  result.class_code = utils.Cp1251ToUtf8( assert(neg_deal.class_code, "The given 'neg_deal' table has no 'class_code' field.") )
...
function StructFactory.create_NegTrade(neg_trade, existing_struct)
  ...
  result.class_code = utils.Cp1251ToUtf8( assert(neg_trade.class_code, "The given 'neg_trade' table has no 'class_code' field.") )
...
function StructFactory.create_StopOrder(stop_order, existing_struct)
  ...
  result.account = utils.Cp1251ToUtf8( assert(stop_order.account, "The given 'stop_order' table has no 'account' field.") )
  ...
  result.client_code = utils.Cp1251ToUtf8( assert(stop_order.client_code, "The given 'stop_order' table has no 'client_code' field.") )
  ...
  result.class_code = utils.Cp1251ToUtf8( assert(stop_order.class_code, "The given 'stop_order' table has no 'class_code' field.") )
...
function StructFactory.create_Security(security, existing_struct)
  ...
  result.class_code = utils.Cp1251ToUtf8( assert(security.class_code, "The given 'security' table has no 'class_code' field.") )
...
function StructFactory.create_ParamEventInfo(param) 
  ...
  result.class_code = utils.Cp1251ToUtf8( assert(param.class_code, "The given 'param' table has no 'class_code' field.") )
...
function StructFactory.create_QuoteEventInfo(quote) 
  ...
  result.class_code = utils.Cp1251ToUtf8( assert(quote.class_code, "The given 'quote' table has no 'class_code' field.") )
...
function StructFactory.create_Klass(class_info, existing_struct)
  ...
  result.code = utils.Cp1251ToUtf8( assert(class_info.code, "The given 'class_info' table has no 'code' field.") )
